...
- `agoose77` — Hi all :wave:, I'm an OS Application Engineer at 2i2c, here on behalf of the Jupyter Book team. I'm joining these Collab Cafés following a suggestion from Kirstie Whitaker that the Jupyter Book team share this space: {%preview https://github.com/jupyter-book/team-compass/issues/20#issuecomment-2749522676 %}

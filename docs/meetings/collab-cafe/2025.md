...
* Raniere: a Christmas wafer [https://en.wikipedia.org/wiki/Christmas\_wafer](https://en.wikipedia.org/wiki/Christmas\_wafer)
...
* Kirstie: [https://github.com/jupyterhub/team-compass/issues/842](https://github.com/jupyterhub/team-compass/issues/842)
  * Particularly: [https://github.com/jupyterhub/team-compass/issues/842#issuecomment-3570459508](https://github.com/jupyterhub/team-compass/issues/842#issuecomment-3570459508)
  * "At" symbol, i.e. @, should be allowed in URL: [https://github.com/jupyter-book/mystmd/issues/2591](https://github.com/jupyter-book/mystmd/issues/2591)
  * Duplicate identifier warning incorrect: [https://github.com/jupyter-book/mystmd/issues/2592](https://github.com/jupyter-book/mystmd/issues/2592)
  * Link to mybinder.org trigger DOI: [https://github.com/jupyter-book/mystmd/issues/2593](https://github.com/jupyter-book/mystmd/issues/2593)
* Raniere: Raniere was selected as Software Sustainability Institute Fellow 🚀Congratulations!!
  * Video with the ideas for Raniere's fellowship: [https://youtu.be/f05FkIHGu6I?si=I2PPygIlz63G7rth](https://youtu.be/f05FkIHGu6I?si=I2PPygIlz63G7rth)
* Angus: MEP process, MyST sync meetings, groundwork for outputs etc.

### Breakout room and agenda item suggestions

* @Min Adding [https://bids.mybinder.org](https://bids.mybinder.org) to the federation
...
* Freek asked about WYSIWYG options
  ...
  * if someone were to develop, consider codemirror/prosemirror; however, check the student report from delft, they already looked into this and have a working prototype (unclear if its using sphinx or mystmd), see their report here: [https://github.com/orgs/jupyter-book/discussions/2404](https://github.com/orgs/jupyter-book/discussions/2404)
  * --> students tried quill, then discovered prosemirror was better: [https://lopalov.github.io/Final-Report/main/research/markdown\_conversion.html#editor](https://lopalov.github.io/Final-Report/main/research/markdown\_conversion.html#editor)
...
* Voices of JH Report blog posts - drafting (did this last week) 
    * [Link to report](https://voicesofjupyterhub.orgmycology.com)
...
1. Communications Plan for [Voices of JupyterHub Report](https://voicesofjupyterhub.orgmycology.com/intro)
